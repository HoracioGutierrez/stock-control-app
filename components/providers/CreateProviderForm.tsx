          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid gap-2">
              <div>
                ...
                {errors.lastName && <p className="text-red-500 font-bold text-sm">{errors.lastName.message}</p>}
              </div>
            ...
            <div className="grid gap-2">
              <div>
                ...
                {errors.cuitCuil && <p className="text-red-500 font-bold text-sm">{errors.cuitCuil.message}</p>}
              </div>
            ...
            <div className="grid gap-2">
              <div>
                ...
                {errors.companyName && <p className="text-red-500 font-bold text-sm">{errors.companyName.message}</p>}
              </div>
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              <div>
                ...
                {errors.address && <p className="text-red-500 font-bold text-sm">{errors.address.message}</p>}
              </div>
            ...
            <div className="grid gap-2">
              <div>
                ...
                {errors.phone && <p className="text-red-500 font-bold text-sm">{errors.phone.message}</p>}
              </div>
