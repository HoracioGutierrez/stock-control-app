    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 col-span-2">
        {dataForHelp.map((item, index) => (
          <div key={index} className="pl-6 pr-6 bg-primary-foreground dark:bg-card transition-transform hover:scale-[1.01] shadow-md rounded-lg max-w-sm col-span-1 active:scale-[0.98] duration-10 hover:shadow-lg cursor-pointer dark:bg-gradient-to-br from-transparent to-black" >
