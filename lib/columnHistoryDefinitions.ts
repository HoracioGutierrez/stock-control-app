...
import { cashRegistersColumns, customersColumns, historyColumns, ordersColumns, productsColumns, providersColumns } from "./columnDefinitions"

export const columns: Record<"products" | "history" | "providers" | "customers" | "cash-registers" | "orders", ColumnDef<unknown | any>[]> = {
